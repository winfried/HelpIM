...
DATABASES = {
    'default': {
        ...
        'NAME': 'testchat3',                       # Or path to database file if using sqlite3.
        'USER': 'testchat3',                       # Not used with sqlite3.
        'PASSWORD': 'Jc4i2i1D',                 # Not used with sqlite3.
...
BOT = {
    ...
    'logging': {
        'destination': 'file:/var/log/helpim/testchat3.log',
        'level': 'debug',
        'level_pyxmpp': 'info',
        }
    }
