...
DATABASES = {
    'default': {
        ...
        'NAME': 'testchat2',                       # Or path to database file if using sqlite3.
        'USER': 'testchat2',                       # Not used with sqlite3.
        'PASSWORD': 'nyG78gnw',                 # Not used with sqlite3.
...
BOT = {
    ...
    'logging': {
        'destination': 'file:/var/log/helpim/testchat2.log',
        'level': 'debug',
        'level_pyxmpp': 'info',
        }
    }
