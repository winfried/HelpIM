...
DATABASES = {
    'default': {
        ...
        'NAME': 'testchat',                       # Or path to database file if using sqlite3.
        'USER': 'testchat',                       # Not used with sqlite3.
        'PASSWORD': 'Lz7ajFdP',                 # Not used with sqlite3.
...
BOT = {
    ...
    'logging': {
        'destination': 'file:/var/log/helpim/testchat.log',
        'level': 'debug',
        'level_pyxmpp': 'info',
        }
    }
