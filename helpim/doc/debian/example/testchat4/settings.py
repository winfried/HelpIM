...
DATABASES = {
    'default': {
        ...
        'NAME': 'testchat4',                       # Or path to database file if using sqlite3.
        'USER': 'testchat4',                       # Not used with sqlite3.
        'PASSWORD': '9Rn958qi',                 # Not used with sqlite3.
...
BOT = {
    ...
    'logging': {
        'destination': 'file:/var/log/helpim/testchat4.log',
        'level': 'debug',
        'level_pyxmpp': 'info',
        }
    }
