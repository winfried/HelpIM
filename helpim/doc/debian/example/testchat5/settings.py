...
DATABASES = {
    'default': {
        ...
        'NAME': 'testchat5',                       # Or path to database file if using sqlite3.
        'USER': 'testchat5',                       # Not used with sqlite3.
        'PASSWORD': '2IL5koKR',                 # Not used with sqlite3.
...
BOT = {
    ...
    'logging': {
        'destination': 'file:/var/log/helpim/testchat5.log',
        'level': 'debug',
        'level_pyxmpp': 'info',
        }
    }
