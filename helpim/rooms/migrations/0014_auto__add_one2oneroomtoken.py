...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'One2OneRoomToken'
        db.create_table('rooms_one2oneroomtoken', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rooms.One2OneRoom'])),
            ('token', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rooms.AccessToken'])),
        ))
        db.send_create_signal('rooms', ['One2OneRoomToken'])


    def backwards(self, orm):
        
        # Deleting model 'One2OneRoomToken'
        db.delete_table('rooms_one2oneroomtoken')
