...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'One2OneRoom.client_allocated_at'
        db.add_column('rooms_one2oneroom', 'client_allocated_at', self.gf('django.db.models.fields.DateTimeField')(default='1000-01-01 00:00:00'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'One2OneRoom.client_allocated_at'
        db.delete_column('rooms_one2oneroom', 'client_allocated_at')
