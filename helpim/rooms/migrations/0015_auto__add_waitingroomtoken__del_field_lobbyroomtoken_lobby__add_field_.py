...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WaitingRoomToken'
        db.create_table('rooms_waitingroomtoken', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rooms.WaitingRoom'])),
            ('token', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rooms.AccessToken'], unique=True)),
            ('ready', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('rooms', ['WaitingRoomToken'])

        # Deleting field 'LobbyRoomToken.lobby'
        db.delete_column('rooms_lobbyroomtoken', 'lobby_id')

        # Adding field 'LobbyRoomToken.room'
        db.add_column('rooms_lobbyroomtoken', 'room', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rooms.LobbyRoom']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'WaitingRoomToken'
        db.delete_table('rooms_waitingroomtoken')

        # Adding field 'LobbyRoomToken.lobby'
        db.add_column('rooms_lobbyroomtoken', 'lobby', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rooms.LobbyRoom']), keep_default=False)

        # Deleting field 'LobbyRoomToken.room'
        db.delete_column('rooms_lobbyroomtoken', 'room_id')
