...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rooms_waitingroom', (
            ('lobbyroom_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rooms.LobbyRoom'], unique=True, primary_key=True)),
            ('lobbyroom', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['rooms.LobbyRoom'])),
        ))
    ...
    models = {
        ...
        'rooms.waitingroom': {
            'Meta': {'object_name': 'WaitingRoom', '_ormbases': ['rooms.LobbyRoom']},
            'lobbyroom': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['rooms.LobbyRoom']"}),
            'lobbyroom_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['rooms.LobbyRoom']", 'unique': 'True', 'primary_key': 'True'})
        }
    }
