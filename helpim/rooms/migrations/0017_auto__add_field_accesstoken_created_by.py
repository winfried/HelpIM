...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccessToken.created_by'
        db.add_column('rooms_accesstoken', 'created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccessToken.created_by'
        db.delete_column('rooms_accesstoken', 'created_by_id')
