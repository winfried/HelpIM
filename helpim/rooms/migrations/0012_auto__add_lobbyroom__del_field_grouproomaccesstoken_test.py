...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GroupRoomAccessToken.test'
        db.delete_column('rooms_grouproomaccesstoken', 'test')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'GroupRoomAccessToken.test'
        db.add_column('rooms_grouproomaccesstoken', 'test', self.gf('django.db.models.fields.CharField')(default='hallowelt', max_length=32), keep_default=False)
