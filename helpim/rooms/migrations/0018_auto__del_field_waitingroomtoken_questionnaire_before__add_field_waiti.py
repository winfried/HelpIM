...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WaitingRoomToken.questionnaire_before'
        db.delete_column('rooms_waitingroomtoken', 'questionnaire_before_id')

        # Adding field 'WaitingRoomToken.conversation_form_entry'
        db.add_column('rooms_waitingroomtoken', 'conversation_form_entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questionnaire.ConversationFormEntry'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'WaitingRoomToken.questionnaire_before'
        db.add_column('rooms_waitingroomtoken', 'questionnaire_before', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forms.FormEntry'], null=True), keep_default=False)

        # Deleting field 'WaitingRoomToken.conversation_form_entry'
        db.delete_column('rooms_waitingroomtoken', 'conversation_form_entry_id')
    ...
    models = {
        ...
        'questionnaire.conversationformentry': {
            ...
            'entry_at': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'rooms.waitingroomtoken': {
            ...
            'conversation_form_entry': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['questionnaire.ConversationFormEntry']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
