...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rooms_accesstoken', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conversations.Participant'], null=True)),
        ))
        db.send_create_signal('rooms', ['AccessToken'])


    def backwards(self, orm):
        
        # Deleting model 'AccessToken'
        db.delete_table('rooms_accesstoken')
