...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LobbyRoomToken'
        db.create_table('rooms_lobbyroomtoken', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lobby', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rooms.LobbyRoom'])),
            ('token', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rooms.AccessToken'], unique=True)),
        ))
        db.send_create_signal('rooms', ['LobbyRoomToken'])

        # Deleting field 'AccessToken.owner'
        db.delete_column('rooms_accesstoken', 'owner_id')


    def backwards(self, orm):
        
        # Deleting model 'LobbyRoomToken'
        db.delete_table('rooms_lobbyroomtoken')

        # Adding field 'AccessToken.owner'
        db.add_column('rooms_accesstoken', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conversations.Participant'], null=True), keep_default=False)
