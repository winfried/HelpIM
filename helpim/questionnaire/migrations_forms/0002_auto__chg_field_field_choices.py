...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('forms_field', 'choices', self.gf('django.db.models.fields.CharField')(max_length=5000))


    def backwards(self, orm):
        
        # Changing field 'Field.choices'
        db.alter_column('forms_field', 'choices', self.gf('django.db.models.fields.CharField')(max_length=1000))
