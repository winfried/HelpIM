...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('forms_fieldentry', 'value', self.gf('django.db.models.fields.CharField')(max_length=5000))

        # Changing field 'Field.default'
        db.alter_column('forms_field', 'default', self.gf('django.db.models.fields.CharField')(max_length=5000))


    def backwards(self, orm):
        
        # Changing field 'FieldEntry.value'
        db.alter_column('forms_fieldentry', 'value', self.gf('django.db.models.fields.CharField')(max_length=2000))

        # Changing field 'Field.default'
        db.alter_column('forms_field', 'default', self.gf('django.db.models.fields.CharField')(max_length=2000))
    ...
    models = {
        'forms.field': {
            ...
            'default': ('django.db.models.fields.CharField', [], {'max_length': '5000', 'blank': 'True'}),
