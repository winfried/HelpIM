...
# Create global permissions for stats app.
...
# create permissions when running 'syncdb' after stats app has been handled
post_syncdb.connect(create_stats_permissions, sender=sys.modules[__name__])
