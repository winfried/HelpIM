...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BuddyChatProfile.last_email_reminder'
        db.add_column('buddychat_buddychatprofile', 'last_email_reminder', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 1, 0)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BuddyChatProfile.last_email_reminder'
        db.delete_column('buddychat_buddychatprofile', 'last_email_reminder')
    ...
    models = {
        ...
        'buddychat.buddychatprofile': {
            ...
            'last_email_reminder': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(1970, 1, 1, 1, 0)'}),
