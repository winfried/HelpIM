...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BuddyChatProfile'
        db.create_table('buddychat_buddychatprofile', (
            ...
            ('volunteer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal('buddychat', ['BuddyChatProfile'])


    def backwards(self, orm):
        
        # Deleting model 'BuddyChatProfile'
        db.delete_table('buddychat_buddychatprofile')
    ...
    models = {
        ...
        'buddychat.buddychatprofile': {
            ...
            'volunteer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
