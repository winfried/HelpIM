...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'QuestionnaireFormEntry'
        db.create_table('buddychat_questionnaireformentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forms.FormEntry'], null=True, blank=True)),
            ('questionnaire', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questionnaire.Questionnaire'])),
            ('buddychat_profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='questionnaires', to=orm['buddychat.BuddyChatProfile'])),
            ('position', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('buddychat', ['QuestionnaireFormEntry'])


    def backwards(self, orm):
        
        # Deleting model 'QuestionnaireFormEntry'
        db.delete_table('buddychat_questionnaireformentry')
