...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field comments on 'Message'
        db.create_table('conversations_message_comments', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('message', models.ForeignKey(orm['conversations.message'], null=False)),
            ('threadedcomment', models.ForeignKey(orm['threadedcomments.threadedcomment'], null=False))
        ))
        db.create_unique('conversations_message_comments', ['message_id', 'threadedcomment_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field comments on 'Message'
        db.delete_table('conversations_message_comments')
