...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename field 'Conversation.start_time' -> 'Conversation.created_at'
        db.rename_column('conversations_conversation', 'start_time', 'created_at')


    def backwards(self, orm):
        
        # Rename field 'Conversation.created_at' -> 'Conversation.start_time'
        db.rename_column('conversations_conversation', 'created_at', 'start_time')
