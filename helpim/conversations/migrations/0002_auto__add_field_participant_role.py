...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participant.role'
        db.add_column('conversations_participant', 'role', self.gf('django.db.models.fields.CharField')(max_length=2, null=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Participant.role'
        db.delete_column('conversations_participant', 'role')
