...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participant.ip_hash'
        db.add_column('conversations_participant', 'ip_hash', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)

        # Adding field 'Participant.blocked'
        db.add_column('conversations_participant', 'blocked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Participant.ip_hash'
        db.delete_column('conversations_participant', 'ip_hash')

        # Deleting field 'Participant.blocked'
        db.delete_column('conversations_participant', 'blocked')
