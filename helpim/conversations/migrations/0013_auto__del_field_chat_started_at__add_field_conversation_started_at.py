...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Chat.started_at'
        db.delete_column('conversations_chat', 'started_at')

        # Adding field 'Conversation.started_at'
        db.add_column('conversations_conversation', 'started_at', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Chat.started_at'
        db.add_column('conversations_chat', 'started_at', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Deleting field 'Conversation.started_at'
        db.delete_column('conversations_conversation', 'started_at')
    ...
    models = {
        ...
        'conversations.chat': {
            'Meta': {'ordering': "['created_at']", 'object_name': 'Chat', '_ormbases': ['conversations.Conversation']},
        ...
        'conversations.conversation': {
            'Meta': {'ordering': "['created_at']", 'object_name': 'Conversation'},
        ...
        'conversations.message': {
            ...
            'conversation': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'messages'", 'to': "orm['conversations.Conversation']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
